...
public class funcionesp3 {
    ...
    public static Connection conecta_bd(BufferedWriter v_log_buf){
        ...
        try{
            v_conexion = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/taller", "app", "DAM23/24");
    ...
    public static void imprimeTabla(ResultSet i_datos, BufferedWriter v_log_buf) throws SQLException{
        ...
        while(i_datos.next()){
            ...
            for(int i = 1; i <= v_num_colum; i++){
                ...
                //System.out.print(i_datos.getString(i));//Datos de la fila
                String st = v_rs_metadatos.getColumnName(i);
                System.out.println(st + " | " + i_datos.getString(st));
            }
            System.out.println("*************************************");
